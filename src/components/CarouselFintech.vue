<template>
  <div class="flex items-stretch gap-2">
    <button @click="prev" class="hidden sm: block w-6 h-auto bg-gray-primary flex justify-center items-center pointer">
      <DynamicIcon 
    ...
    <button @click="next" class="hidden sm: block w-6 h-auto bg-gray-primary flex justify-center items-center pointer">
      <DynamicIcon 
